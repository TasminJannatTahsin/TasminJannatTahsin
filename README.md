...
I have worked on practical projects involving like **Manual and database Testing of a Website, Hospital Management System Database Testing, Rest API Testing such as Restfulbooker API and studet details API, API Testing with data driven, Performance Testing by using website URL and Rest API** etc.
